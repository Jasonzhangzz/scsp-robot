...
from examples.mpc.franka.test_benchmark.woRS.params_wors import ExplicitMPCParams
...
DEFAULT_RECORD_OUTPUT_DIR = "/home/lab423/scsp/scsp-robot/outputs/videos_wors"
...
def main():
    ...
    parser.add_argument("--low-err-coef-flag0", type=float, default=1.0, help="low_err_coef used when best_contact_torque_scale_flag=0; defaults to --low_err_coef")
    parser.add_argument("--low-err-coef-flag1", type=float, default=1.0, help="low_err_coef used when best_contact_torque_scale_flag=1; defaults to --low_err_coef")
    parser.add_argument("--upper-err-coef-flag0", type=float, default=1.0, help="upper_err_coef used when best_contact_torque_scale_flag=0; defaults to --upper_err_coef")
    parser.add_argument("--upper-err-coef-flag1", type=float, default=1.0, help="upper_err_coef used when best_contact_torque_scale_flag=1; defaults to --upper_err_coef")
    ...
    parser.add_argument("--trial-start", type=int, default=0, help="first trail index to evaluate from the loaded trails.json/trials.json")
